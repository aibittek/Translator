...
public class WebTTSWS {
    ...
    public static void getTTSData(String text, String vcnString, @NonNull IResponseResult permissionsResult) throws Exception {
        mText = text;
        mVcn = vcnString;
...
//                String format = "{\"common\":{\"app_id\":\"%s\"},\"business\":{\"vcn\":\"%s\",\"aue\":\"raw\",\"speed\":\"50\"},\"data\":{\"status\":2,\"encoding\":\"UTF8\",\"text\":\"%s\"}}";
                ...
                try {
                    String reqData = String.format(format, appid, mVcn, 50, 50, Base64.encodeToString(mText.getBytes("utf8"), Base64.NO_WRAP));
